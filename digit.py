...
digit_pcp = PerceptronClassifier()
...
for i in percentages:
    ...
    start = time.time()
    digit_nb.fit(train_data_temp, train_labels_temp)
    end = time.time()
    accuracy = digit_nb.accuracy(test_data, test_labels)
    accuracies_bayes.append(accuracy)
    standard_deviations_bayes.append(digit_nb.standard_deviation(test_data, test_labels))
    times_bayes.append(end-start)
    print(f'Training Data Used: {i:.0f}%')
    print(f'Accuracy: {100*accuracy:.2f}%')
    print(f'Standard Deviation: {digit_nb.standard_deviation(test_data, test_labels):.2f}')
...
for i in percentages:
    ...
    train_labels_temp = train_labels[:(int(i/100*len(train_labels)))]
    start = time.time()
    digit_pcp.fit(train_data_temp, train_labels_temp)
    end = time.time()
    accuracy = digit_pcp.accuracy(test_data, test_labels)
    accuracies_pcp.append(accuracy)
    standard_deviations_pcp.append(digit_pcp.standard_deviation(test_data, test_labels))
    times_pcp.append(end-start)
    print(f'Training Data Used: {i:.0f}%')
    print(f'Accuracy: {100*accuracy:.2f}%')
    print(f'Standard Deviation: {digit_pcp.standard_deviation(test_data, test_labels):.2f}')
    print(f'Training Time: {end-start:.9f} seconds')
...
plt.ylabel('Accuracy')
plt.savefig(f'{PLOTS_DIR}digit_bayes_percentages_vs_accuracy.png')
...
plt.savefig(f'{PLOTS_DIR}digit_bayes_percentages_vs_standard_deviation.png')
...
plt.savefig(f'{PLOTS_DIR}digit_bayes_percentages_vs_time.png')
...
plt.xlabel('Percentage of Training Data')
plt.ylabel('Accuracy')
plt.savefig(f'{PLOTS_DIR}digit_pcp_percentages_vs_accuracy.png')
...
plt.xlabel('Percentage of Training Data')
plt.ylabel('Standard Deviation')
plt.savefig(f'{PLOTS_DIR}digit_pcp_percentages_vs_standard_deviation.png')
...
plt.xlabel('Percentage of Training Data')
plt.ylabel('Training Time (s)')
plt.savefig(f'{PLOTS_DIR}digit_pcp_percentages_vs_time.png')